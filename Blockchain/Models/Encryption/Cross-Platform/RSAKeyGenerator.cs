    ...
    public class RSACryptographyKeyGenerator{
        public RSAKeysTypes GenerateKeys(RSAKeySize rsaKeySize){
            ...
            if(keySize%2 != 0 || keySize <512){
                throw new Exception("Key should multiple of two and greater than 512");
            }
            var rsaKeyTypes = new RSAKeysTypes();
            using (var provider = new RSACryptoServiceProvider(keySize)){
                ...
                rsaKeyTypes.PublicKey = publicKeyWithSize;
                rsaKeyTypes.PrivateKey = privateKeyWithSize;
            }
            return rsaKeyTypes;
        }
